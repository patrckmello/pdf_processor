...
def split_pdfs():
    ...
    logging.info(f"Recebido pedido de split: {len(files)} arquivo(s), {parts} partes.")
    ...
    with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zipf:
        for file_storage in files:
            ...
            try:
                ...
                logging.info(f"Dividindo '{filename}' com {total_pages} páginas em {parts} partes.")
